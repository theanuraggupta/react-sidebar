...
const Default = () => {
    ...
    return (<div className="control-section" id="sidebar-wrapper">
            ...
            <div className="maincontent">
                <ListViewComponent id="listView" ref={listObj} template={listTemplate} cssClass="e-list-template" dataSource={data} fields={fields} select={onListSelect.bind(this)}></ListViewComponent>
            </div>
